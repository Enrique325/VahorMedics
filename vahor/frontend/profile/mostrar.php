<?php
    ...
    $username = $_SESSION['username']; // ID del usuario logueado
        ...
        <ul class="side-menu">
            ...
            <li>
                ...
                <ul class="side-dropdown">
                    ...
                    <li><a href="../medicinas/categoria.php">Categoría</a></li>
                </ul>
            </li>
            <li>
        ...
        <main>
            ...
            <?php if ($data) { ?>
                <form action="" enctype="multipart/form-data" method="POST" autocomplete="off" onsubmit="return validacion()">
                    <div class="containerss">
                        ...
                        <input type="text" value="<?php echo $data['username']; ?>" placeholder="ejm: admin01" name="prouser" required>
                        ...
                        <input type="text" value="<?php echo $data['name']; ?>" placeholder="ejm: admin" name="proname" required>

                        <label for="email"><b>Correo del perfil</b></label><span class="badge-warning">*</span>
                        <input type="text" value="<?php echo $data['email']; ?>" placeholder="ejm: admin@gmail.com" name="proema" required>
            ...
            <?php } else { ?>
                <div class="alert">
                    ...
                    <strong>Danger!</strong> No se encontró el perfil.
                </div>
            <?php } ?>
        </main>
    </section>
